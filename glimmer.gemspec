...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<array_include_methods>.freeze, [">= 1.2.0", "< 2.0.0"])
    ...
    s.add_dependency(%q<array_include_methods>.freeze, [">= 1.2.0", "< 2.0.0"])
