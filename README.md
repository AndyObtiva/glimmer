...
- Available Windows packaging types are `msi`, `exe`, and `image` (image means a Windows `app` directory without a setup program). More details about Windows are [over here](#windows-application-packaging).
